...
const Navbar = () => {
  return (
    <nav className="fixed z-20 w-full h-auto bg-transparent backdrop-blur p-4 shadow-md flex justify-between items-center pl-30 md:pl-20">
     ...
     <MagneticButton ><a href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:ae319c45-11b7-4e56-9323-cd27830f8a08" className='px-4 py-3 border-2 border-white rounded-2xl bg-transparent' >My Resume</a></MagneticButton>
    </nav>
  );
};
