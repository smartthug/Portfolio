...
const About = () => {
    return (
      <section id="about" className="p-20 flex justify-between sm:flex-col ">
...
I love bringing creative ideas to life through clean code and modern design. I&apos;m a quick learner, flexible with work shifts, and always eager to take on new challenges.
        ...
        <div >
          <h1 className=" flex gap-4 font-bold text-3xl mb-8 items-center md:gap-2 md:text-2xl">{<FaLaptopCode className="text-[var(--secondary)] text-4xl"></FaLaptopCode>}Use at work</h1>
          <ul className="flex gap-4 flex-wrap text-2xl md:text-xl">
